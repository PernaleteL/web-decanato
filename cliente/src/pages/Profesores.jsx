    ...
    <>
      ...
      <Navbar />
        ...
        <div className="cont-profesores">
          ...
          <p className="p-profesores">En esta sección podrás conocer a nuestro talentoso equipo de profesores, quienes destacan por su dedicación a la excelencia académica, la investigación y el compromiso con la formación integral de nuestros estudiantes. </p>
          </div>
        <div className="cont-profesores">
                    ...
                    <div className="flex flex-col justify-between flex-1 p-6 bg-white">
                      <div className="flex-1">
                        <a href="#" className="block mt-2">
                          ...
                          <p className=" text-base text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit facilis asperiores porro quaerat doloribus, eveniet dolore.</p>
                          <p className=" text-base text-gray-500">{"Correo de contacto: " + profesor.data.correo}</p>
                          <p className=" text-base text-gray-500">{"Materia que imparte: " + profesor.data.materia}</p>
                        </a>
                      </div>
                    </div>
                  </div>
