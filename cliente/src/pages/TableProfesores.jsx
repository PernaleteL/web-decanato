    ...
    <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead className="ltr:text-left rtl:text-right">
        <tr>
          ...
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Materia 1</th>
          <th className="whitespace-nowrap px-2 py-2 font-medium text-gray-900">Materia 2</th>
      ...
      <tbody className="divide-y divide-gray-200">
        ...
        currentItems.map((profesor) => (
          <tr key={profesor.id}>
            ...
            <td className="whitespace-nowrap px-2 py-2 text-gray-700"> {profesor.data.codigoMateria1}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700"> {profesor.data.codigoMateria2}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700"> {profesor.data.correo}</td>
            <td className="whitespace-nowrap px-2 py-2 text-gray-700"> {profesor.data.roll}</td>
            <td className="td-des px-2 py-2 text-gray-700"> {profesor.data.img}</td>
            <td className="td-des px-2 py-2  h-full column gap-2 text-gray-700 cursor-pointer ">
