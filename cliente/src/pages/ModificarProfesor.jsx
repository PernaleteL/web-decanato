         ...
         <div className=" w-full" >
          ...
          <form onSubmit={handleSubmit} className="pl-8 pr-8">
            ...
            <label htmlFor="password" className="block mb-1 text-sm text-gray-600">
              ...
              <div className="w-[50%]">
            <label htmlFor="materia2" className="block mb-1 text-sm text-gray-600">
                Segunda materia que imparte
            <input
                type="text"
                id="materia2"
                name="materia2"
                className="class-input text-sm  w-full px-4 py-1 border rounded-lg focus:outline-none focus:border-cyan-500"
                value={modificarProfesor.datosProfesor.data.codigoMateria2}
                  onChange={(event) => setModificarProfesor(prevState => ({
                    ...prevState,
                    datosProfesor: {
                      ...prevState.datosProfesor,
                      data: {
                        ...prevState.datosProfesor.data,
                        codigoMateria2: event.target.value,
                      },
                    },
                  }))}
            />
