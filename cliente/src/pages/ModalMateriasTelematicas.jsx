...
<p className="mt-1 text-md font-medium text-gray-600">Profesor de la asignatura: {materia.datosMateria.data.profesor ? materia.datosMateria.data.profesor : ' Actualmente no tiene un profesor'}</p>
